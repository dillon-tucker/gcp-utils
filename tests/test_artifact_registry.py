...
def artifact_registry_controller(settings):
    ...
    with patch('google.cloud.artifactregistry_v1.ArtifactRegistryClient') as mock_client:
...
def test_create_repository_success(artifact_registry_controller):
    ...
    mock_repository.name = "projects/test-project/locations/us-central1/repositories/test-repo"
...
def test_get_repository_not_found(artifact_registry_controller):
    ...
    artifact_registry_controller._client.get_repository.side_effect = Exception("404 Not Found")
...
def test_list_repositories(artifact_registry_controller):
    ...
    artifact_registry_controller._client.list_repositories.return_value = [mock_repository]
